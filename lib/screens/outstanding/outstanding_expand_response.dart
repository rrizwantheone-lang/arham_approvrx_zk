class OutstandingExpandResponse {
  String? message;
  List<OutstandingExpandModel>? data;

  OutstandingExpandResponse({this.message, this.data});

  OutstandingExpandResponse.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    if (json['data'] != null) {
      data = <OutstandingExpandModel>[];
      json['data'].forEach((v) {
        data!.add(OutstandingExpandModel.fromJson(v));
      });
    }
  }
...
class OutstandingExpandModel {
  ...
  OutstandingExpandModel.fromJson(Map<String, dynamic> json) {
    iTEMCD = json['ITEM_CD'];
    sIZECD = json['SIZE_CD'];
