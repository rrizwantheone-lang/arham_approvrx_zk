...
class OutstandingDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          '#${headerData?.pARTYBL?.toString() ?? "Outstanding Details"}',
      ...
      body: Obx(() {
        ...
        if (isWithVouch) {
          final list =
              controller.outstandingExpandWithVocuhList.value.data ?? [];
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    CommonText(
                      text:
                          '${AppDatePicker.convertDateTimeFormat(dueDate!, 'yyyy-MM-dd', 'yyyy-MM-dd')}',
                    ),
            ...
            Column(
              ...
              children: [
                Container(
                  ...
                  child: CommonText(
                    text:
                        "Bill: ₹${Utils.formatIndianAmount(double.tryParse(billAmt ?? '0') ?? 0)}",
                    fontSize: 12,
                ...
                Container(
                  ...
                  child: CommonText(
                    text:
                        "Paid: ₹${Utils.formatIndianAmount(double.tryParse(paidAmt ?? '0') ?? 0)}",
                    fontSize: 12,
                    fontWeight: AppFontWeight.w700,
                ...
                Container(
                  ...
                  child: CommonText(
                    text:
                        "Pending: ₹${Utils.formatIndianAmount(double.tryParse(pendingAmt ?? '0') ?? 0)}",
                    fontSize: 12,
                    fontWeight: AppFontWeight.w700,
