class AccountLedgerExpandResponse {
  String? message;
  List<AccountLedgerExpandModel>? data;

  AccountLedgerExpandResponse({this.message, this.data});

  AccountLedgerExpandResponse.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    if (json['data'] != null) {
      data = <AccountLedgerExpandModel>[];
      json['data'].forEach((v) {
        data!.add(AccountLedgerExpandModel.fromJson(v));
      });
    }
  }
...
class AccountLedgerExpandModel {
  dynamic iTEMCD;
  dynamic sIZECD;
  dynamic qUANTITY;
  dynamic oTHERDESC;
  ...
  AccountLedgerExpandModel.fromJson(Map<String, dynamic> json) {
    iTEMCD = json['ITEM_CD'];
    sIZECD = json['SIZE_CD'];
