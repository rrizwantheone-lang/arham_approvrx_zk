...
class LedgerDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "#${headerData?.bILLNO.toString() ?? 'Ledger Details'}",
                ...
                Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: CommonText(
                            text:
                                "Dr ₹${Utils.formatIndianAmount(double.tryParse(drAmt ?? '0') ?? 0)}",
                            fontSize: 12,
                        ...
                        Container(
                          ...
                          child: CommonText(
                            text:
                                "Cr ₹${Utils.formatIndianAmount(double.tryParse(crAmt ?? '0') ?? 0)}",
                            fontSize: 12,
                            fontWeight: AppFontWeight.w700,
                    ...
                    Container(
                      ...
                      child: CommonText(
                        text:
                            "Balance ₹${Utils.formatIndianAmount(double.tryParse(balanceAmt ?? '0') ?? 0)}",
                        fontSize: 12,
                        fontWeight: AppFontWeight.w700,
                        color: theme.colorScheme.primary,
                      ),
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              CommonText(
                text: "₹${Utils.formatIndianAmount(totalBill)}",
                fontWeight: FontWeight.bold,
                textAlign: TextAlign.start,
              ),
  ...
  Widget _totalContainerWithVouch(
    BuildContext context,
    double totalBill,
    double totalPaid,
  ) {
          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(
                child: CommonText(
                  text:
                      "Total Bill Amount: ₹${Utils.formatIndianAmount(totalBill)}",
                  fontWeight: FontWeight.bold,
                  textAlign: TextAlign.start,
                ),
              ),
              ...
              Expanded(
                child: CommonText(
                  text:
                      "Total Paid Amount: ₹${Utils.formatIndianAmount(totalPaid)}",
                  fontWeight: FontWeight.bold,
