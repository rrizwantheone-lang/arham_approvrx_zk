...
class SalesBaseView extends StatelessWidget {
  SalesBaseView({super.key});

  final SalesBaseController controller = Get.put(SalesBaseController());
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  onTap: () {
                                    controller.clear();
                                    Get.find<SalesBaseController>().firmFocus
                                        .unfocus();
                                    Get.find<SalesBaseController>()
                                    ...
                                    Get.find<SalesBaseController>()
                                        .currentPage
                                        .value = 1;
                                    Get.find<SalesBaseController>().fetchData();
                                  },
                                  child: const Padding(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              //   child: CommonText(
                              //     text:
                              //         'Qty: ${ledgers.qUANTITY?.toString() ?? '0'}',
                              //   ),
                              // ),
                              Flexible(
                                child: CommonText(
                          ...
                          // CommonText(
                          //   text: 'Distributor : ${ledgers.fIRMNAME ?? ""}',
                          //   color: Theme.of(context).colorScheme.primary,
                          // ),
                        ],
                      ),
