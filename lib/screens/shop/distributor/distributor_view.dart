...
class DistributorView extends StatelessWidget {
        ...
        () => Container(
          ...
          child: Column(
            children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  onTap: () {
                                    controller.clear();
                                    Get.find<DistributorController>().firmFocus
                                        .unfocus();
                                    ...
                                    Get.find<DistributorController>()
                                        ...
                                        .data
                                        ?.clear();
                                    Get.find<DistributorController>().searchList
                                        .clear();
                                    Get.find<DistributorController>().mainList
                                        .refresh();
                                    // Get.find<DistributorController>()
                                    //     .fetchProduct();
                                  },
              ...
              //       ? Center(child: Utils.commonCircularProgress())
              //       : (controller.deptList.value.data == null ||
              //           controller.deptList.value.data!.isEmpty)
              //       ? Container()
              //       : TypeAheadField<DepartmentModel>(
              //         controller: controller.deptController.value,
              //         focusNode: controller.deptFocus,
              //         suggestionsCallback: (pattern) async {
              //           return controller.deptList.value.data?.where((item) {
              ...
              //             title: CommonText(
              //               text:
              //                   suggestion.dEPTNAME != null &&
              //                           suggestion.dEPTNAME!.trim().isNotEmpty
              //                       ? "${suggestion.dEPTCD.toString().trim()} | ${suggestion.dEPTNAME.toString().trim()}"
              //                       : suggestion.dEPTNAME.toString().trim(),
              //               fontWeight: AppFontWeight.w400,
              //               fontSize: 14,
              //             ),
              //           );
              //         },
              //         onSelected: (DepartmentModel selectedItem) {
              //           controller.selectedDropdownDept.value = selectedItem;
              //           controller.selectedDropdownDeptCode.value =
              //               selectedItem.dEPTCD.toString().trim();
              //           controller.deptController.value.text =
              //               selectedItem.dEPTNAME.toString().trim();
              //           Utils.closeKeyboard(Get.context!);
              //           controller.deptFocus.unfocus();
              //
              //           controller.fetchProduct();
              //         },
              //         builder: (context, controller, focusNode) {
              ...
              //                         Utils.closeKeyboard(Get.context!);
              //
              //                         if (Get.find<DistributorController>()
              //                                 .selectedDropdownFirmCode
              //                                 .value
              //                                 .isNotEmpty &&
              //                             Get.find<DistributorController>()
              ...
              //                                 .text
              //                                 .isNotEmpty) {
              //                           await Get.find<DistributorController>()
              //                               .fetchProductBySearch();
              //                         }else if(Get.find<DistributorController>()
              //                             .selectedDropdownFirmCode
              //                             .value
              //                             .isNotEmpty &&
              //                             Get.find<DistributorController>()
              ...
              //                                 .isEmpty){
              //
              //                           Get.find<DistributorController>().mainList.value.data?.clear();
              //                           Get.find<DistributorController>().searchList.clear();
              //                         }
              //
              //                         // Get.find<DistributorController>()
              //                         //     .mainList
              ...
              //             ? Icons.close
              //             : null,
              //     hintText: "Search here (Min 3 Char)... (i.e,Name ,Content)",
              //     maxLength: 40,
              ...
              //TODO : Department & Search Horizontal Set
              if (controller.selectedDropdownFirmCode.isNotEmpty)
                Row(
                  children: [
                    Expanded(
                          ...
                          controller.debounce = Timer(
                            ...
                            () async {
                              if (controller.searchQuery.value.isEmpty) {
                                ...
                                if (controller.searchQuery.value.length >= 3) {
                                  print(
                                    "Firm: ${controller.selectedDropdownFirmCode.value}",
                                  );
                                  print(
                                    "Dept: ${controller.selectedDropdownDeptCode.value}",
                                  );
                                  print(
                                            ...
                                            if (controller
                                              ...
                                              await controller
                                                ...
                                                controller
                                                    ...
                                                    .text
                                                    .isEmpty) {
                                              controller.mainList.value.data
                                                  ?.clear();
                                              controller.searchList.clear();
  ...
  Widget _getView(BuildContext context) {
    ...
    if (controller.mainList.value.data == null ||
        controller.mainList.value.data!.isEmpty) {
      // Delay the "no data" message by 3 seconds
      return FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            return SizedBox(); // Or a light placeholder
          }
        },
      );
    }
  ...
  Widget _listUI(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final hasCstk = ledgers.cSTK != null;
        final hasStockLevel =
            ledgers.stockLevel != null && ledgers.stockLevel!.trim().isNotEmpty;
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          //       //         ? 'Out of Stock'
                          //       //         : stock < 100
                          //       //         ? 'Low Stock: ${Utils.formatIndianAmount(double.parse(ledgers.cSTK?.toString() ?? '0'))}'
                          //       //         : 'Stock: ${Utils.formatIndianAmount(double.parse(ledgers.cSTK?.toString() ?? '0'))}',
                          //       text:
                          //           '${Utils.formatIndianAmount(double.parse(ledgers.cSTK?.toString() ?? ''))} ',
                          //       color:
                          //           stock <= 0
                          //               ? Colors.red
                          //               : stock < 100
                    ...
                    Obx(() {
                      ...
                      return Column(
                        children: [
                          ...
                          if (status != 'success' || ledgers.cartStatus!)
                            Visibility(
                              visible: false,
                              child: Row(
                                children: [
                              ...
                              children: [
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    // if (ledgers.quantity.value >= ledgers.aVLSTK!) {
