...
class ProductResponse {
  ...
  ProductResponse({this.data, this.payload});
  ...
  static Payload _parsePayload(dynamic json) {
    if (json is Map<String, dynamic>) {
      return Payload.fromJson(json);
    }
    // Fallback if payload is an empty string or invalid
    return Payload();
  }
...
class Deptment {
  ...
  Deptment({this.dEPTCD, this.dEPTNAME, this.gROUPING, this.sYNCID});
